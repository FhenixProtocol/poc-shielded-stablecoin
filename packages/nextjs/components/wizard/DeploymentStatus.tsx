    ...
    return (
      <div className="mt-3 p-3 bg-base-200 border border-fhenix-border rounded-sm">
        <div className="flex items-center gap-2 mb-2">
          ...
          <p className="text-sm font-pixel text-fhenix-muted uppercase tracking-widest">
            {"// Waiting for Confirmation"}
          </p>
        </div>
        <p className="text-sm font-pixel text-fhenix-muted uppercase tracking-widest mb-1">
          TX Hash:
        </p>
    ...
    return (
      <div className="mt-3 p-3 bg-fhenix-primary/10 border border-fhenix-primary rounded-sm">
        <div className="flex items-center gap-2 mb-3">
          ...
          <p className="text-sm font-pixel text-fhenix-primary uppercase tracking-widest">
